...
- Memory/MongoDB: harden manager cache identity with workspace-aware bridge paths, keep bridge-note retrieval from crowding live runtime memory, and tighten namespace-safe bridge sync plus exact reads.
