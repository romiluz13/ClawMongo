...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  {
    id: "memory_active_slate",
    label: "memory_active_slate",
    description: "Read active runtime state and blockers",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "memory_discovery_projection",
    label: "memory_discovery_projection",
    description: "Project changes, contradictions, and briefs",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "memory_context_bundle",
    label: "memory_context_bundle",
    description: "Assemble prompt-ready memory context",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  ...
  },
  {
    id: "kb_search",
    label: "kb_search",
    description: "Search imported knowledge base",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
  {
    id: "memory_write",
    label: "memory_write",
    description: "Write structured memory records",
    sectionId: "memory",
    profiles: ["coding"],
    includeInOpenClawGroup: true,
  },
